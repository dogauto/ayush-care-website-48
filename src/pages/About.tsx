...
const About = () => {
  return (
    <main className="bg-[#f8f9fa] py-16 min-h-[80vh] animate-fade-in">
      <div className="max-w-6xl mx-auto w-full px-4 flex flex-col md:flex-row items-center md:items-start gap-10 animate-slide-in">
        {/* Circular Human Image */}
        <div className="flex-shrink-0 flex items-center justify-center w-[320px] h-[320px] bg-gray-200 rounded-full shadow-md overflow-hidden border-4 border-white animate-scale-in">
          <img
        ...
        <div className="flex-1 animate-fade-in">
          ...
          <a
            href="#"
            className="inline-flex items-center px-6 py-3 rounded-lg border border-green-400 text-green-700 font-semibold hover:bg-green-50 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-green-300 animate-fade-in"
          >
